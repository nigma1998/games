...
<div class="block">
    ...
    <ul class="delim-list padtop_s">
        ...
        <li class="padtop_s first-li ">
                    ...
                    <div class="card-body">
                      <form  method="post" action="{{ route('gem.taim.update', ['taim'=> $buton]) }}" onchange="this.form.submit()" enctype="multipart/form-data">


                        <img class="icon" width="58" height="58" src="{{ Storage::url($buton->image_url)}}"/>
                        <div>
                            <a href="/Reception/Treat?repIndex=1&roomIndex=1&t=637967616171613494&page=1">{{$buton->product_name}}</a><span class="smallfont minor">, </span>
