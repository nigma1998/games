...
<head>
    ...
    <link href="{{ asset('js/vendor/modernizr-2.8.3.min.js') }}" rel="stylesheet">
    <!-- modernizr JS
		============================================ -->
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Панель</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="nps" href="{{ route('admin.nps.index') }}"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Nps</span></a></li>
                        ...
                        <li id="removable">
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="fa big-icon fa-files-o icon-wrap"></i> <span class="mini-click-non">Редактор</span></a>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                ...
                                                <li class="nav-item"><a href="#" class="nav-link">Модератор</a>
                                                </li>
                                                <li class="nav-item"><a href="#" class="nav-link">Админестратор</a>
                                                </li>
                                                <li class="nav-item"><a href="#" class="nav-link">Разработчик</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item dropdown">
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu"><!--в меню почта-->
                                                            <li>
                                                                <a href="#">
